                            ...
                            <div class="row g-4 fruite">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <ul class="list-unstyled fruite-categorie">
                                            ...
                                            <li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    <a href="#"><i class="fas fa-apple-alt me-2"></i>Aus</a>
                                                    <span>(5)</span>
                                                </div>
                                            </li>
                                            <li>
                                ...
                                <div class="mb-4">
                                    ...
                                    <ul class="list-unstyled fruite-categorie">
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="#"><i class="fas fa-apple-alt me-2"></i>Gaming</a>
                                                <span>(3)</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="#"><i class="fas fa-apple-alt me-2"></i>Văn Phòng</a>
                                                <span>(5)</span>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="#"><i class="fas fa-apple-alt me-2"></i>Trâu bò</a>
                                                <span>(8)</span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="#"><i class="fas fa-apple-alt me-2"></i>Đồ Họa</a>
                                                <span>(5)</span>
                                            </div>
                                        </li>
                                    </ul>
